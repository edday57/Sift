...
df['postcode_prefix'] = df.postal_code.str.split(" ", expand = True)[0]
selected_features=['price', 'house_type', 'area_in_sq_ft','no._of_bedrooms','no._of_bathrooms','no._of_receptions', 'location', 'postcode_prefix']
cat_features=['house_type', 'location', 'postcode_prefix']
...
#print(calculate_cosine_similarity(554, listings_data))
